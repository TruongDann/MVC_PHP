                ...
                <div class="col-lg-12">
                    <div class="breacumb-content">
                        ...
                        <div class="breadcumb-content-text">
                            <a href="index.html"> home <i class="fas fa-angle-right"></i><span>Shopping Cart</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="m-4">
              ...
              <div class="row gy-3">
                <div class="col-lg-5">
                  <div class="me-lg-5">
                    <div class="d-flex">
                      <img src="<?= _WEB_ROOT; ?>/public/uploads/products/2023_10/{{$cart['thumbnail']}}" class="border rounded me-3" style="width: 96px; height: 96px;" />
                      <div class="">
                        <a href="#" class="nav-link">{{$cart['name']}}</a>
                ...
                <div class="col-lg-2 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                  <div class="">
                    <input type="number" style="width: 100px;" value="{{$cart['quality']}}" class="form-select me-4">
                  </div>
                  <div class="">
                    <text class="h6">{{$cart['price']}}</text> <br />
          ...
          <div class="card shadow-0 border">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                ...
                <p class="mb-2">{{number_format(Session::data('totalPrice'))}}</p>
              </div>
              <div class="d-flex justify-content-between">
              ...
              <div class="d-flex justify-content-between">
                <p class="mb-2">Total price:</p>
                <p class="mb-2 fw-bold">{{number_format(Session::data('totalPrice'))}}</p>
              </div>
